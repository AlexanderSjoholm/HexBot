...
#define wall_dist_2 0x100 //Detta värde stämmer inte
#define wall_dist_3 0x50 //Detta värde stämmer inte

unsigned char adc_ch;
volatile unsigned char mode;
extern unsigned char measurements[6];
unsigned char reads;
...
void ADCinit();
void read_sensors();
unsigned char get_measurements(unsigned char);
void set_measurements(unsigned char, unsigned char);
